...
class TestBase_load_from_file(unittest.TestCase):
    """testing the `load_from_file` method of the Base class."""
...
class TestBase_save_to_file_csv(unittest.TestCase):
    """testing the `save_to_file_csv` method of the Base class."""
...
class TestBase_load_from_file_csv(unittest.TestCase):
    """testing the `load_from_file_csv` method of the Base class."""
